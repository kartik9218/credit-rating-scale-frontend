...
import DataTableHeadCell from "slots/Tables/DataTable/DataTableHeadCell";
import DataTableBodyCell from "slots/Tables/DataTable/DataTableBodyCell";
...
function DataTable({
  ...
  return (
    <TableContainer className="table-wrapper" sx={{color:"#758084",fontWeight:"700",boxShadow: "none", height:customHeight ? customHeight : "calc(100vh - 35vh)"}}>
      {entriesPerPage || canSearch ? (
        <ArgonBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
          {(isPaginationVisible && entriesPerPage) && (
            <ArgonBox display="flex" alignItems="center" gap={"30px"}>
              <ArgonBox width="25%">
                 <ArgonSelect
...
DataTable.propTypes = {
  ...
  customHeight: PropTypes.string || PropTypes.bool,
};
